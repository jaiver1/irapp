        ...
        <div class="container-fluid">
            ...
            <div class="card mb-4 wow fadeIn hoverable">
                ...
                <div class="card-body d-sm-flex justify-content-between">
                    ...
                    <span class="fa-stack">
  <i class="fa fa-object-group fa-stack-1x fa-lg"></i>
        ...
        responsive: {
            details: {
                display: $.fn.dataTable.Responsive.display.modal( {
                    header: function ( row ) {
                        var data = row.data();
                        return '<span class="fa-stack"><i class="fa fa-object-group fa-stack-1x fa-lg"></i> <i class="fa fa-ban fa-stack-1x fa-2x text-danger"></i></span> Datos de la especialidad eliminada "'+ data[1]+'"';
                    }
                } ),
