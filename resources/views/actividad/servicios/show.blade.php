...
<div class="list-group hoverable">
  <a class="list-group-item active z-depth-2 white-text waves-light hoverable">
      <i class="fas fa-object-group  mr-2"></i><strong>Especialidad #{{ $especialidad->id }}</strong>
    </a>
  <a class="list-group-item waves-effect hoverable"><strong><i class="fas mr-4"></i>Nombre: </strong>{{ $especialidad->nombre }}</a>
</div>
                        </div>
    ...
    @foreach($especialidad->categorias as $key => $categoria)
      <tr class="hoverable">
        ...
        <td><i class="fas fa-object-group"></i> {{$categoria->especialidad->nombre}}</td>
        <td>
