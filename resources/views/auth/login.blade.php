...
@endif
                                            ...
                                            <div class="text-center">
                                                <button class="btn btn-outline-white hoverable waves-light" data-wow-delay="0.4s" role="button">
                                                    <i class="fa fa-door-closed mr-2"></i>Iniciar sesión</button>
                                    ...
                                    <div class="white-text">
                                        <h1 class="h1-responsive font-weight-bold wow fadeInRight" data-wow-delay="0.3s">Sign up right now! </h1>
