        ...
        <div class="container-fluid">
            ...
            <div class="card mb-4 wow fadeIn hoverable">
                ...
                <div class="card-body d-sm-flex justify-content-between">
                    ...
                    <span><i class="fas fa-balance-scale fa-lg mr-1"></i></span>   <span>@if ($tipos_medidas->count() === 1)
                Un tipo de medida
        ...
        responsive: {
            details: {
                display: $.fn.dataTable.Responsive.display.modal( {
                    header: function ( row ) {
                        var data = row.data();
                        return '<i class="fas fa-balance-scale fa-lg"></i> Datos de tipo de medida "'+ data[1]+'"';
                    }
                } ),
